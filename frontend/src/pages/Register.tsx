  ...
  return (
    <div className="mx-auto flex min-h-[calc(100vh-73px)] w-full max-w-md items-center px-4 py-10">
      <div className="w-full rounded-3xl border border-zinc-800 bg-[#181818] p-8 shadow-2xl shadow-black/30">
        <p className="text-sm uppercase tracking-[0.2em] text-red-400">Join the creator side</p>
        <h1 className="mt-3 text-3xl font-bold text-white">Register</h1>
        <p className="mt-2 text-sm text-zinc-400">Create a local account and keep your profile synced in the app.</p>
        ...
        <p className="mt-6 text-sm text-zinc-400">
          ...
          <Link to="/login" className="font-semibold text-white hover:text-red-400">
            Sign in
          </Link>
        </p>
      </div>
